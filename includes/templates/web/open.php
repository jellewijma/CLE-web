...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="text-center mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Openings tijden</h1>
    </div>
    <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          <p class="title-font font-medium">Ma - 16:00 - 23:59</p>
        </div>
      </div>
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          <p class="title-font font-medium">Di - 16:00 - 23:59</p>
        </div>
      </div>
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          <p class="title-font font-medium">Wo - 16:00 - 23:59</p>
        </div>
      </div>
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          <p class="title-font font-medium">Do - 16:00 - 23:59</p>
        </div>
      </div>
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          <p class="title-font font-medium">Vr - 16:00 - 23:59</p>
        </div>
      </div>
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          <p class="title-font font-medium">Za - 16:00 - 23:59</p>
        </div>
      </div>

    </div>
    <a href="<?= BASE_PATH ?>index#reserveer" class="flex mx-auto mt-16 text-white bg-[#620d0d] border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Reserveren</a>
  </div>
</section>
