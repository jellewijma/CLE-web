...
<?php if (!empty($errors)) { ?>
  <div class="absolute top-4 inset-x-[calc(50vw-192px)] flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md animate-duration-300 opacity-0" id="success-popup">
        ...
        <?php if (isset($web)) : ?>
          <form action="" method="post" class="flex flex-wrap">
            ...
            <div class="p-2 w-full">
              ...
              <button type="submit" name="submit" class="flex mx-auto text-white bg-[#620d0d] border-0 py-2 px-8 focus:outline-none hover:bg-red-950 rounded text-lg">Button</button>
            </div>
          </form>
        <?php endif;  ?>
      </div>
